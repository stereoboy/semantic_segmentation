...
def init_weights():
  ...
  WEs = {
      ...
      "9":tf.get_variable('e_conv_9', shape = [1, 1, 384, FLAGS.nclass], initializer=init_with_normal()),
      "10":tf.get_variable('e_conv_10', shape = [1, 1, 384, FLAGS.nclass], initializer=init_with_normal()),
      }
